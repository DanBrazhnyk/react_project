...
import { allwhyte} from "../importsImg/ImportsImg";
import ShoesTemplate from "./Template/ShoesTemplate";
 ...
 const Allwhyte =()=>{
    ...
    const imgStyle = {
      ...
      const price ="$120"
 return(
    <ShoesTemplate srcImg={allwhyte} price={price}imgStyle={imgStyle} text={text} textStyle={textStyle} title={title} titleStyle={titleStyle} />
 )
 }
 export default Allwhyte